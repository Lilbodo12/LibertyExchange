 ...
 * This file demonstrates how to integrate Libertyexchange with a web frontend
 */

// For React/Vue/Angular applications
export class LibertyexchangeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new LibertyexchangeClient(provider, contractAddress);
