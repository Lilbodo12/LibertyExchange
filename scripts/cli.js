...
const contractABI = require("../artifacts/contracts/Libertyexchange.sol/Libertyexchange.json").abi;

program
    .name("libertyexchange-cli")
    .description("CLI tool for Libertyexchange smart contract")
    .version("1.0.0");
